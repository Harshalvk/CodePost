        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <Icons.logo className="h6 w-6" />
              <span className="text-md font-semibold">CodePost</span>
            </div>
            <p className="text-gray-500 dark:text-gray-400 text-sm">
              Stay up to date with latest news and insights from our blog.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://x.com/Harshalvk_"
                target="_blank"
                rel="My Twiiter account"
                aria-label="twitter"
              >
                <Icons.twitter className="h-6 w-6 text-gray-500 hover:text-gray-700 dark:hover:text-gray-300" />
              </a>
              <a
                ...
                aria-label="github"
              >
                <Icons.github className="h-6 w-6 text-gray-500 hover:text-gray-700 dark:hover:text-gray-300" />
              </a>
            </div>
          </div>
          <div className="space-y-4">
              ...
              >
                {state?.errors?.email &&
                  state.errors.email.map((error: string) => (
                    <p key={error} className="text-as text-red-500">
                      {error}
                    </p>
                  ))}
